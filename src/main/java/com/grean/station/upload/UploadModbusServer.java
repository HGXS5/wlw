...
public class UploadModbusServer extends UploadInter {
    ...
    public UploadModbusServer() {
    }

    public byte[] getBootTimePkg(String strQN, String strFlag) {
        byte[] bSend = new byte[]{83, 87, 77, 119, 97, 116, 101, 114, (byte)Integer.parseInt(this.mUploadCfg.getMn())};
        return bSend;
    }

    public byte[] getHeartBeatPkg(String strQN, String strFlag) {
        return this.getBootTimePkg(strQN, strFlag);
    }
