...
public class Upload212_QDSX extends UploadInter {
    public Upload212_QDSX() {
    }
    ...
    public byte[] getHourDataPkg(String strQN, String strFlag, RecDataTime recDataTime, int factorID) {
        ...
        if (recDataList == null) {
            ...
            String strSend = "ST=" + this.mUploadCfg.getSt() + ";CN=2061;PW=" + this.mUploadCfg.getPassword() + ";MN=" + this.mUploadCfg.getMn() + ";CP=&&";
            ...
            while(true) {
                while(true) {
                    ...
                    do {
                        ...
                        } while(cfgFactor.getCodeGJ().length() <= 0);
