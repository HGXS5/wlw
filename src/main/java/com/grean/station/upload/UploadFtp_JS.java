...
public class UploadFtp_JS extends UploadInter {
    public UploadFtp_JS() {
    }
    ...
    public byte[] getHourDataPkg(String strQN, String strFlag, RecDataTime recDataTime, int factorID) {
        ...
        if (recDataList == null) {
            ...
            strSend = strSend + "<?xml version=\"1.0\" encoding=\"gb2312\" ?>\r\n";
            strSend = strSend + "<EMSiteData  xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" SiteId=\"" + this.mUploadCfg.getMn() + "\" EMGUID=\"053a9c7f38f04d23846bc4ab89d97783\">\r\n";
            strSend = strSend + "\t<UploadData>\r\n";
                ...
                while(true) {
                    ...
                    while(var9.hasNext()) {
                        ...
                        if (recDataFactor.getFactorID() == cfgFactor.getId()) {
                            if (cfgFactor.getCodeSL() != null && cfgFactor.getCodeSL().length() > 0) {
                                strSend = strSend + "\t\t<EMDataRecord SamplingTime=\"" + TimeHelper.formatDataTime_yyyy_MM_dd_HH_mm_ss(recDataTime.getRecTime()) + "\" Status=\"1\" Value=\"" + recDataFactor.getDataValue() + "\" Code=\"" + cfgFactor.getCodeSL() + "\" />\r\n";
                            }
                            break;
                        }
                    }
