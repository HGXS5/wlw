...
public class Upload212_ZJ extends UploadInter {
    public Upload212_ZJ() {
    }
    ...
    private byte[] getDevTimePkg(String strQN, String strFlag, String factorCode) {
        for(int i = 0; i < this.mMonitor.cfgFactorList.size(); ++i) {
            if (((CfgFactor)this.mMonitor.cfgFactorList.get(i)).getCodeZJ().equals(factorCode)) {
    ...
    private boolean setDevCmd(int cmdType, String strQN, String factorCode, String strParam) {
        if (factorCode == null) {
            ...
            while(var5.hasNext()) {
                ...
                if (cfgFactor.getCodeZJ().equals(factorCode)) {
        ...
        if (devService.getDevExeListener() == null) {
            devService.setDevExeListener(new DevExeListener() {
                public void OnExeEvent(String cmdQN, int cmdID, int exeResult) {
                    if (cmdQN.length() > 0) {
                        Upload212_ZJ.this.sendExeResult(cmdQN, cmdID, exeResult);
                    }

                    if (exeResult == 1) {
                        Upload212_ZJ.this.mMonitor.saveRecLogSys("系统日志", "启动" + devService.getDevName() + "成功");
                    } else {
                        Upload212_ZJ.this.mMonitor.saveRecLogSys("系统日志", "启动" + devService.getDevName() + "失败");
                    }
            ...
            this.mMonitor.sampleService.setSampleExeListener(new SampleExeListener() {
                public void OnExeEvent(String cmdQN, int cmdID, int exeResult, String strDataTime, String strVaseNo) {
                    if (exeResult == 1 && cmdID == 3015) {
                        byte[] bSend = Upload212_ZJ.this.getRsrvSamplePkg(cmdQN, "8", strDataTime, strVaseNo);
                        Upload212_ZJ.this.mInterComm.Send(bSend);
                    }
    ...
    public byte[] getRealTimePkg(String strQN, String strFlag, RecDataTime recDataTime, int factorID) {
        ...
        if (recDataList == null) {
            ...
            for(int i = 0; i < this.mMonitor.cfgFactorList.size(); ++i) {
                ...
                if ((factorID <= 0 || factorID == cfgFactor.getId()) && cfgFactor.isUsed() && (cfgFactor.isFiveType() || cfgFactor.isParmType()) && cfgFactor.getCodeZJ() != null) {
                    for(int j = 0; j < recDataList.size(); ++j) {
                        if (((RecDataFactor)recDataList.get(j)).getFactorID() == cfgFactor.getId()) {
                            strSend = strSend + ";" + cfgFactor.getCodeZJ() + "-Rtd=" + ((RecDataFactor)recDataList.get(j)).getDataString() + ",";
        ...
        if (recDataList == null) {
            ...
            while(true) {
                while(true) {
                    ...
                    } while(cfgFactor.getCodeZJ() == null);
                    ...
                    while(var9.hasNext()) {
                        ...
                        if (recDataAvg.getFactorID() == cfgFactor.getId()) {
                            strSend = strSend + ";" + cfgFactor.getCodeZJ() + "-Avg=" + recDataAvg.getDataValue() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-Flag=" + recDataAvg.getDataFlag();
                            break;
                        }
                    }
                }
    ...
    public byte[] getHourDataPkg(String strQN, String strFlag, RecDataTime recDataTime, int factorID) {
        ...
        if (recDataList == null) {
            ...
            for(int i = 0; i < this.mMonitor.cfgFactorList.size(); ++i) {
                CfgFactor cfgFactor = (CfgFactor)this.mMonitor.cfgFactorList.get(i);
                if ((factorID <= 0 || factorID == cfgFactor.getId()) && cfgFactor.isUsed() && cfgFactor.isUpload() && (cfgFactor.isParmType() || cfgFactor.isFiveType() || cfgFactor.isSysType() || cfgFactor.isSwType()) && cfgFactor.getCodeZJ() != null) {
                    for(int j = 0; j < recDataList.size(); ++j) {
                        if (((RecDataFactor)recDataList.get(j)).getFactorID() == cfgFactor.getId()) {
                ...
                if ((factorID <= 0 || factorID == cfgFactor.getId()) && cfgFactor.isUsed() && cfgFactor.isFiveType() && cfgFactor.getCodeZJ() != null) {
                    ...
                    while(var9.hasNext()) {
                        ...
                        if (recCheckFive.getFactorID() == cfgFactor.getId()) {
                            strSend = strSend + ";" + cfgFactor.getCodeZJ() + "-Check=" + recCheckFive.getCurValue() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-StandardValue=" + recCheckFive.getStdValue() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-Flag=" + recCheckFive.getDataFlag();
                            break;
                        }
                    }
                }
    ...
    public byte[] getStdCheckPkg(String strQN, String strFlag, RecDataTime recDataTime, int factorID) {
        ...
        if (recDataList == null) {
            ...
            for(int i = 0; i < this.mMonitor.cfgFactorList.size(); ++i) {
                CfgFactor cfgFactor = (CfgFactor)this.mMonitor.cfgFactorList.get(i);
                if ((factorID <= 0 || factorID == cfgFactor.getId()) && cfgFactor.isUsed() && cfgFactor.isParmType() && cfgFactor.getCodeZJ() != null) {
                    for(int j = 0; j < recDataList.size(); ++j) {
                        if (((RecCheckStd)recDataList.get(j)).getFactorID() == cfgFactor.getId()) {
                            strSend = strSend + ";" + cfgFactor.getCodeZJ() + "-Check=" + ((RecCheckStd)recDataList.get(j)).getTestValue() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-StandardValue=" + ((RecCheckStd)recDataList.get(j)).getStdValue() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-Flag=" + ((RecCheckStd)recDataList.get(j)).getDataFlag();
                            break;
                        }
                    }
                }
                ...
                if ((factorID <= 0 || factorID == cfgFactor.getId()) && cfgFactor.isUsed() && cfgFactor.isParmType() && cfgFactor.getCodeZJ() != null) {
                    for(int j = 0; j < recDataList.size(); ++j) {
                        if (((RecCheckZero)recDataList.get(j)).getFactorID() == cfgFactor.getId()) {
                            strSend = strSend + ";" + cfgFactor.getCodeZJ() + "-Check=" + ((RecCheckZero)recDataList.get(j)).getCurValue() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-StandardValue=" + ((RecCheckZero)recDataList.get(j)).getStdValue() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-SpanValue=" + ((RecCheckZero)recDataList.get(j)).getSpanValue() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-Flag=" + ((RecCheckZero)recDataList.get(j)).getDataFlag();
                            break;
                        }
                    }
                }
                ...
                if ((factorID <= 0 || factorID == cfgFactor.getId()) && cfgFactor.isUsed() && cfgFactor.isParmType() && cfgFactor.getCodeZJ() != null) {
                    for(int j = 0; j < recDataList.size(); ++j) {
                        if (((RecCheckRcvr)recDataList.get(j)).getFactorID() == cfgFactor.getId()) {
                            strSend = strSend + ";" + cfgFactor.getCodeZJ() + "-Check=" + ((RecCheckRcvr)recDataList.get(j)).getAfterValue() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-WaterTime=" + TimeHelper.formatDataTime_yyyyMMddHHmmss(((RecCheckRcvr)recDataList.get(j)).getBeforeTime()) + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-Water=" + ((RecCheckRcvr)recDataList.get(j)).getBeforeValue() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-Chroma=" + ((RecCheckRcvr)recDataList.get(j)).getMotherValue() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-Volume=" + ((RecCheckRcvr)recDataList.get(j)).getMotherVolume() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-DVolume=" + ((RecCheckRcvr)recDataList.get(j)).getCupVolume() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-Flag=" + ((RecCheckRcvr)recDataList.get(j)).getDataFlag();
                            break;
                        }
                    }
                }
                ...
                if ((factorID <= 0 || factorID == cfgFactor.getId()) && cfgFactor.isUsed() && cfgFactor.isParmType() && cfgFactor.getCodeZJ() != null) {
                    for(int j = 0; j < recDataList.size(); ++j) {
                        if (((RecCheckPar)recDataList.get(j)).getFactorID() == cfgFactor.getId()) {
                            strSend = strSend + ";" + cfgFactor.getCodeZJ() + "-Check=" + ((RecCheckPar)recDataList.get(j)).getValue2nd() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-WaterTime=" + TimeHelper.formatDataTime_yyyyMMddHHmmss(((RecCheckPar)recDataList.get(j)).getRecTime()) + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-Water=" + ((RecCheckPar)recDataList.get(j)).getValue1st() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-Flag=" + ((RecCheckPar)recDataList.get(j)).getDataFlag();
                            break;
                        }
                    }
                }
    ...
    public byte[] getLogDevPkg(String strQN, String strFlag, RecDataTime recDataTime, String PolID) {
        ...
        if (recLogDevList == null) {
            ...
            if (PolID == null) {
                        ...
                        while(var10.hasNext()) {
                            ...
                            if (recLogDev.getFactorID() == cfgFactor.getId()) {
                                if (recLogDev.getLogDesc() != null) {
                                    bCheck = true;
                                    strSend = strSend + ";PolId=" + cfgFactor.getCodeZJ() + ",i11001-Info=//" + recLogDev.getLogDesc() + "//";
                                }
                                break;
                            }
                        }
                ...
                while(var8.hasNext()) {
                    cfgFactor = (CfgFactor)var8.next();
                    if (cfgFactor.isUsed() && cfgFactor.getCodeZJ().equals(PolID)) {
                        var10 = recLogDevList.iterator();
                        ...
                        do {
                            ...
                            recLogDev = (RecLogDev)var10.next();
                        } while(recLogDev.getFactorID() != cfgFactor.getId() || cfgFactor.getCodeZJ() == null);
    ...
    public byte[] getStateDevPkg(String strQN, String strFlag, RecDataTime recDataTime, String PolID, String InfoID) {
        ...
        if (PolID == null) {
            for(i = 0; i < this.mMonitor.cfgFactorList.size(); ++i) {
                ...
                if (cfgFactor.isUsed() && (cfgFactor.isFiveType() || cfgFactor.isParmType()) && cfgFactor.getCodeZJ() != null) {
    ...
    public byte[] getParamDevPkg(String strQN, String strFlag, RecDataTime recDataTime, String PolID, String InfoID) {
        ...
        if (PolID == null) {
            for(i = 0; i < this.mMonitor.cfgFactorList.size(); ++i) {
                cfgFactor = (CfgFactor)this.mMonitor.cfgFactorList.get(i);
                if (cfgFactor.isUsed() && cfgFactor.getCodeZJ() != null) {
        ...
        if (InfoID == null) {
            for(j = 0; j < this.mMonitor.devServiceList.size(); ++j) {
                if (cfgFactor.getDevID() == ((DevService)this.mMonitor.devServiceList.get(j)).getDevID()) {
                    strTmp = strTmp + ";PolId=" + cfgFactor.getCodeZJ();
    ...
    public byte[] getFlowDataPkg(String strQN, String strFlag, RecDataTime recDataTime, int factorID) {
        ...
        if (recDataList == null) {
            ...
            for(int i = 0; i < this.mMonitor.cfgFactorList.size(); ++i) {
                CfgFactor cfgFactor = (CfgFactor)this.mMonitor.cfgFactorList.get(i);
                if (cfgFactor.isUsed() && cfgFactor.isSwType() && cfgFactor.getCodeZJ() != null && (factorID <= 0 || factorID == cfgFactor.getId())) {
                    for(int j = 0; j < recDataList.size(); ++j) {
                        if (((RecDataFactor)recDataList.get(j)).getFactorID() == cfgFactor.getId()) {
                            strSend = strSend + ";" + cfgFactor.getCodeZJ() + "-Rtd=" + ((RecDataFactor)recDataList.get(j)).getDataString() + ",";
                            strSend = strSend + cfgFactor.getCodeZJ() + "-Flag=" + ((RecDataFactor)recDataList.get(j)).getDataFlag();
