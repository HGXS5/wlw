...
public class CommFtp extends CommInter {
    FtpUtil ftpUtil;
    FTPClient ftpClient;
    String ftpHost;
    int ftpPort;
    ...
    public CommFtp(String ftpHost, int ftpPort, String ftpUserName, String ftpPassword, String filePath, String ftpPath, String ftpMN) {
        ...
        if (bSend == null) {
            ...
            if (this.ftpClient != null && this.ftpClient.isConnected()) {
                try {
                    ...
                    String strName = "CWS_0001_" + strDate + "_0003_" + this.ftpMN + ".xml";
