...
public class UdpHandlerModbus extends SimpleChannelInboundHandler {
  ...
  public UdpHandlerModbus(UdpNetClientModbus client) {
    this.client = client;
  }
  ...
  public void channelInactive(ChannelHandlerContext ctx) throws Exception {
    ...
    eventLoop.schedule(new Runnable() {
      public void run() {
        UdpHandlerModbus.this.client.createBootstrap(new Bootstrap(), eventLoop);
      }
    }, 1L, TimeUnit.SECONDS);
