...
public class InboundHandlerLine extends SimpleChannelInboundHandler {
    ...
    public InboundHandlerLine(CommNetClientLine client) {
        this.client = client;
    }
    ...
    public void channelInactive(ChannelHandlerContext ctx) throws Exception {
        ...
        eventLoop.schedule(new Runnable() {
            public void run() {
                InboundHandlerLine.this.client.createBootstrap(new Bootstrap(), eventLoop);
            }
        }, 1L, TimeUnit.SECONDS);
