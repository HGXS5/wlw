...
public class CommFtpQD extends CommInter {
  FtpUtil ftpUtil;
  FTPClient ftpClient;
  String ftpHost;
  int ftpPort;
  ...
  public CommFtpQD(String ftpHost, int ftpPort, String ftpUserName, String ftpPassword, String filePath, String ftpPath, String ftpAreaCode, String ftpStationCode) {
