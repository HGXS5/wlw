...
public class InboundHandlerSerial extends SimpleChannelInboundHandler {
  ...
  public InboundHandlerSerial(CommNetClientSerial client) {
    this.client = client;
  }
  ...
  public void channelInactive(ChannelHandlerContext ctx) throws Exception {
    ...
    eventLoop.schedule(new Runnable() {
      public void run() {
        InboundHandlerSerial.this.client.createBootstrap(new Bootstrap(), eventLoop);
      }
    }, 1L, TimeUnit.SECONDS);
