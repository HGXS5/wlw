...
public class InboundHandlerSzy206 extends SimpleChannelInboundHandler {
  ...
  public InboundHandlerSzy206(CommNetClientSzy206 client) {
    this.client = client;
  }
  ...
  public void channelInactive(ChannelHandlerContext ctx) throws Exception {
    ...
    eventLoop.schedule(new Runnable() {
      public void run() {
        InboundHandlerSzy206.this.client.createBootstrap(new Bootstrap(), eventLoop);
      }
    }, 1L, TimeUnit.SECONDS);
