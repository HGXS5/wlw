...
public class UdpHandlerLine extends SimpleChannelInboundHandler {
  ...
  public UdpHandlerLine(UdpNetClientLine client) {
    this.client = client;
  }
  ...
  public void channelInactive(ChannelHandlerContext ctx) throws Exception {
    ...
    eventLoop.schedule(new Runnable() {
      public void run() {
        UdpHandlerLine.this.client.createBootstrap(new Bootstrap(), eventLoop);
      }
    }, 1L, TimeUnit.SECONDS);
